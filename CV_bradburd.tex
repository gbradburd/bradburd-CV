...
\rule{0pt}{3ex}
34. \labbie{Hancock, ZB}, NE Adams, PL Wood, \bburd{GS Bradburd}.
\pubyear{2025}.
...
\\[\littlepubspace em]
\fi
33. Smith, SA, JB Pease, T Carruthers, \bburd{GS Bradburd}, IB Huegele, GW Stull, WN Weaver, Y Yang, TS Yi, JM Beaulieu.
\pubyear{2025}.
Longevity in plants impacts phylogenetic and population dynamics.
\journal{New Phytologist} \textit{(in press)}.
\\[\pubspace em]

32. Clark, MI, ET Hileman, JA Moore, LJ Faust, RE Junge, BN Reid, DR Bradke, \bburd{GS Bradburd}, SW Fitzpatrick. 
\pubyear{2025}.
Inbreeding reduces fitness in spatially structured populations of a threatened rattlesnake,
\journal{Proceedings of the National Academy of Sciences}
122 (34) e2501745122.\\\\[-0.3 em]
%
%
...
\hfill\\
Talbot, CA, GS Bradburd (2025). \textbf{ARGscape}. An interactive platform for simulating, analyzing, 
and visualizing Ancestral Recombination Graphs across space and time. Python package v0.3.0.
\href{https://www.argscape.com/}{https://www.argscape.com/}\\
%
\vspace{-0.01cm}
%
Hancock, ZB, GS Bradburd (2025). \textbf{sandwrm}. A method for inferring Wright's neighborhood size 
and deep population diversity from spatial genomic data. R package v0.1.0.
\href{https://github.com/zachbhancock/sandwrm}{https://github.com/zachbhancock/sandwrm}\\
%
\vspace{-0.01cm}
%
Grundler, M, J Terhorst, GS Bradburd (2024). \textbf{GAIA}. A method for inferring the geographic locations of 
shared genetic ancestors in a tree sequence. R package v1.0.
\href{https://github.com/blueraleigh/gaia}{https://github.com/blueraleigh/gaia}\\
%
\vspace{-0.01cm}
%
Bradburd, GS (2018). \textbf{conStruct}. A genetic clustering method that accounts for isolation by distance. R package v1.0.6.
...
\vspace{-0.01cm}
%
Bradburd, GS (2016). \textbf{SpaceMix}. A program for estimating geogenetic maps from allele frequency data. R package v0.13.
...
R package v1.6.1. \href{https://cran.r-project.org/web/packages/BEDASSLE}{https://cran.r-project.org/web/packages/BEDASSLE}\\
%
\end{tabular}
...
%\vspace{0.1cm}
\textbf{NIH NIGMS MIRA (R35)} Award Renewal\# R35GM137919 (2026-20230) & \hfill \textbf{\$2,337,560} \\
...
\textbf{Biodiversity Exploration Fund} (2025-2026) & \hfill \textbf{\$11,586}\\
\hspace{4.5mm}University of Michigan Museum of Natural History\\
\hspace{4.5mm}(PI: G Bradburd. co-PI: Stephen Smith)\\ \vspace{-0.1cm}
...
Mike Grundler & \hfill 2022-2025\\
\hspace{0.5cm} \textit{current position}: Assistant Professor, Southern Illinois University\\
Zach Hancock & \hfill 2021-2025\\
\hspace{0.5cm} \textit{current position}: Assistant Professor, Augusta University\\
...
\rule{0pt}{3ex}Rachel Gutner & \hfill 2025-present\\
...
%jonathan's student Kevin, Mars
Yeishmary Soto Mu\~niz &\hfill PhD, EEB, University of Michigan\\
Greety Wuysang &\hfill Masters, Biology, James Madison University\\
Denise Meier &\hfill PhD, EEB, University of Michigan\\
Jiatong Liang &\hfill PhD, Statistics, University of Michigan\\
%Manar Talab &\hfill Masters, EEB, University of Michigan\\
...
\rule{0pt}{3ex}Isla Roy & \hfill 2025 - present\\
Ben Carlson & \hfill 2024 - present\\
...
\vspace{-0.8cm}
%
\begin{longtable}{>{\everypar{\hangindent1cm}}p{0.60\textwidth}p{0.15\textwidth}p{0.175\textwidth}}
\hfill\\
...
%
\textbf{\textit{Ad hoc} Grant Reviewer}: NSERC, ERC, NSF, Austrian Science Fund, UKRI\\
...
University of Otago & Department of Zoology & \hfill 2026\\
%
