...
%
Mathur, S, A Mason, \bburd{GS Bradburd}, HL Gibbs.
\pubyear{2023}.
Functional genomic diversity more strongly correlated with historical 
than contemporary neutral diversity in an endangered rattlesnake.
\textit{(in revision)}.\\[\weirdpubspace em]
%
%
%
\end{longtable}
...
\rule{0pt}{3ex}Jimmy Bingman, \hspace{0.25cm}PhD, Plant Biology, MSU &\hfill 2023-present\\
