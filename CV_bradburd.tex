...
\hfill\\
Talbot, CA, GS Bradburd (2025). \texttt{ARGscape}. An interactive platform for simulating, analyzing, 
...
%
\textbf{\textit{Ad hoc} Grant Reviewer}: NSERC, ERC, NSF, Austrian Science Fund\\
