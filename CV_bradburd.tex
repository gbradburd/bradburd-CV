...
\journal{Systematic Biology} \textit{(in press)}.\\
%
%
\rule{0pt}{3ex}
Crandall, ED, RH Toczydlowski, L Liggins, 
...
\journal{Conservation Biology} \textit{(in press)}.\\ 
...
\rule{0pt}{3ex}Matheus Januario Lopes de Sousa, \hspace{0.25cm}PhD, EEB, University of Michigan &\hfill 2022-present\\
Enes Dilber, \hspace{0.25cm}PhD, Statistics, University of Michigan &\hfill 2022-present\\
...
\rule{0pt}{3ex}\emph{Ad hoc} Faculty Search Committee  & \hfill 2023\\
%
Seminar Committee (Dept. Ecology and Evolutionary Biology)  & \hfill 2022-present\\
%
