...
\begin{longtable}{>{\everypar{\dohang}\dohang\raggedright\arraybackslash}p{0.95\textwidth}}
\hfill\\
\rule{0pt}{3ex}\textit{\underline{\smash{Published and Accepted}}} \hfill *advisees (e.g., students/postdocs)\\
%
%
\rule{0pt}{3ex}
...
\journal{PNAS} \textit{(accepted).}\\[\pubspace em]
%
\rule{0pt}{3ex}
*Puckett, E., S. Murphy, \bburd{G.S. Bradburd}.
...
\journal{Ecology and Evolution} \textit{(accepted)}.\\[\pubspace em]
%
...
\journal{Molecular Biology and Evolution} \textit{(accepted).}\\[\pubspace em]
%
%
*Hancock, Z.B., E.S. Lehmberg, \bburd{G.S. Bradburd}.
\pubyear{2021}.
